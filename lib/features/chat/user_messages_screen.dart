...
/// Messages screen for DRIVER/USER mode - shows chats where user is the renter
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ChatRoom>>(
        stream: ChatService().getChatRoomsStreamForRenter(currentUser.id),
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Τα μηνύματα θα εμφανιστούν εδώ\nόταν επικοινωνήσετε με έναν host',
